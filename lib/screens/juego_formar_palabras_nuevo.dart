...
class _JuegoFormarPalabrasNuevoState extends State<JuegoFormarPalabrasNuevo> {
  ...
  Widget build(BuildContext context) {
    ...
    return PlantillaJuegoChemaKids(
      ...
      onAyuda: _completado ? null : _onAyuda,
      contenido: _buildContenido(palabra, imgUrl),
    );
  }

  Widget _buildContenido(String palabra, String imgUrl) {
    return Column(
  ...
  Widget _buildLetraDraggable(String letra, {bool dragging = false}) {
    return AnimatedContainer(
      ...
      height: 54,
      decoration: EstilosChemaKids.contenedorJuego(
        color: dragging ? Colors.orange[100] : Colors.white,
        borderColor: dragging ? Colors.orange : Colors.deepPurple,
      ),
      child: Center(
        child: Text(
          letra.toUpperCase(),
          style: TextStyle(
            fontSize: 32,
            color: EstilosChemaKids.colorPrimario,
  ...
  Widget _buildMensajeCompletado() {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '¡Lo lograste!',
                        style: EstilosChemaKids.textoTitulo.copyWith(
                          shadows: [
                            const Shadow(
                              color: Colors.amber,
                              blurRadius: 12,
