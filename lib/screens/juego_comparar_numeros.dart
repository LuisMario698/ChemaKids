...
class _JuegoCompararNumerosState extends State<JuegoCompararNumeros>
  ...
  void _generarPregunta() {
    ...
    setState(() {
      ...
      _objetoIzquierda = _objetosDisponibles[random.nextInt(_objetosDisponibles.length)];
      do {
        _objetoDerecha = _objetosDisponibles[random.nextInt(_objetosDisponibles.length)];
  ...
  void _verificarRespuesta(String respuestaSeleccionada) {
    ...
    if (_esRespuestaCorrecta) {
      ...
      final respuestaTexto = _respuestaCorrecta == 'mayor' 
          ? "El grupo de la izquierda tiene más objetos"
          : "El grupo de la derecha tiene más objetos";
      _ttsService.speak("No es correcto. $respuestaTexto. ¡Inténtalo de nuevo!");
    }
        ...
        builder: (context, child) {
          return Transform.scale(
            ...
            child: GestureDetector(
              ...
              child: MouseRegion(
                cursor: _respondido ? MouseCursor.defer : SystemMouseCursors.click,
                child: Container(
                  margin: const EdgeInsets.symmetric(horizontal: 8, vertical: 12),
                  child: AspectRatio(
                    aspectRatio: 0.75, // Proporción fija para mantener consistencia
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: esIzquierda 
                            ? [Colors.white.withOpacity(0.95), Colors.blue[200]!]
                            : [Colors.white.withOpacity(0.95), Colors.purple[200]!],
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: (esIzquierda ? Colors.blue[700] : Colors.purple[700])!.withOpacity(0.3),
                            blurRadius: 15,
                            spreadRadius: 3,
                        ...
                        border: Border.all(
                          color: esIzquierda ? Colors.blue[800]! : Colors.purple[800]!,
                          width: 3,
                        ),
                      ),
                      child: Column(
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: (esIzquierda ? Colors.blue : Colors.purple).withOpacity(0.4),
                                    blurRadius: 8,
                                    spreadRadius: 2,
                          ...
                          Flexible(
                            ...
                            child: LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                int crossAxisCount = cantidad <= 2 ? cantidad : (cantidad <= 4 ? 2 : 3);
                                double itemSize = constraints.maxWidth / crossAxisCount - 4;
  ...
  Widget _construirBotonComparacion(String respuesta, String texto, IconData icono) {
    Color colorBoton;
          ...
          return Transform.scale(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: _respondido ? null : () => _verificarRespuesta(respuesta),
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(
                minHeight: MediaQuery.of(context).size.height - 
                          (AppBar().preferredSize.height + MediaQuery.of(context).padding.top + MediaQuery.of(context).padding.bottom + (isDesktop ? 48 : 32)),
              ),
              child: Column(
                children: [
                      ...
                      return Opacity(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(color: Colors.deepPurple[600]!, width: 3),
                            boxShadow: [
                              BoxShadow(
                  ...
                  SizedBox(
                    height: isDesktop ? 400 : 300, // Altura fija para las tarjetas
                    child: Row(
                      children: [
                        _construirGrupoObjetos(_objetoIzquierda, _numeroIzquierda, true),
                        ...
                        _construirGrupoObjetos(_objetoDerecha, _numeroDerecha, false),
                      ],
                    ),
                  ),
              ...
              if (!_respondido)
                Padding(
                  ...
                  child: Row(
                    children: [
                      _construirBotonComparacion('mayor', 'Grupo IZQUIERDO\ntiene MÁS', Icons.arrow_back),
                      const SizedBox(width: 16),
                      _construirBotonComparacion('menor', 'Grupo DERECHO\ntiene MÁS', Icons.arrow_forward),
                    ],
                  ),
                ),
              ...
              if (_respondido)
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: (_esRespuestaCorrecta ? Colors.green : Colors.orange).withOpacity(0.4),
                        blurRadius: 15,
                        spreadRadius: 2,
                      ),
                    ],
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        _esRespuestaCorrecta ? Icons.celebration : Icons.refresh,
                        color: Colors.white,
                        size: 36,
                      ),
                      const SizedBox(width: 12),
